...
let part1 s = String.split_lines s |> List.count ~f:is_nice_string |> Int.to_string
let part2 s = String.split_lines s |> List.count ~f:is_nice_string2 |> Int.to_string
