...
let part1 s =
  String.split_lines s |> List.count ~f:supports_tls |> Int.to_string |> Ok

let part2 s =
  String.split_lines s |> List.count ~f:supports_ssl |> Int.to_string |> Ok
